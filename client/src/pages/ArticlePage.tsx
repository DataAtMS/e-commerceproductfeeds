...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Product Feed Research';
    ...
    const pageUrl = 'https://e-commerceproductfeeds.com/articles/' + article.slug;
    const catUrl = 'https://e-commerceproductfeeds.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Product Feed Research' },
      "publisher": { "@type": "Organization", "name": 'Product Feed Research', "url": 'https://e-commerceproductfeeds.com' },
      "url": pageUrl,
    });
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#0a0a0a", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <Link href="/"><span style={{ color: "#00aaff", fontFamily: "monospace", fontSize: "12px", cursor: "pointer" }}>← BACK TO HOME</span></Link>
        </div>
      </div>
    );
  }
