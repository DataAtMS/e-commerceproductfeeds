...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "product-feed-technology": { metaTitle: 'Product feed technology | Product Feed Research', metaDescription: 'Browse 5 articles about product feed technology on Product Feed Research.', h1: 'Product feed technology', intro: 'Browse 5 articles about product feed technology on Product Feed Research.' },
  "ai-visibility": { metaTitle: 'ai visibility | Product Feed Research', metaDescription: 'Browse 5 articles about ai visibility on Product Feed Research.', h1: 'ai visibility', intro: 'Browse 5 articles about ai visibility on Product Feed Research.' },
  "product-feed-tools": { metaTitle: 'product feed tools | Product Feed Research', metaDescription: 'Browse 5 articles about product feed tools on Product Feed Research.', h1: 'product feed tools', intro: 'Browse 5 articles about product feed tools on Product Feed Research.' },
  "ecommerce-technology": { metaTitle: 'ecommerce technology | Product Feed Research', metaDescription: 'Browse 5 articles about ecommerce technology on Product Feed Research.', h1: 'ecommerce technology', intro: 'Browse 5 articles about ecommerce technology on Product Feed Research.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://e-commerceproductfeeds.com/' + slug;
    ...
    setMeta('meta[property="og:site_name"]', 'og:site_name', 'Product Feed Research', 'property');
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://e-commerceproductfeeds.com' },
